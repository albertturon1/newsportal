...
const fetchNews = async () => {
    let limit = 100;
    return await axios.get(`https://api.mediastack.com/v1/news?access_key=${API_KEY}&limit=${limit}&countries=us,gb,de&languages=en&categories=technology`).then(res => res.data);
}
